...
public class ProjectEnvironment extends BaseModel {
...
//    @Column(name = "id")
    ...
    // nested exception is org.hibernate.MappingException: property mapping has wrong number of columns: com.arc.core.model.enviroment.ProjectEnvironment.sourcePrimary type: object
