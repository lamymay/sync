package com.arc.core.model.domain.app.click;
...
public class Click implements Serializable {
     ...
     * @return 转换后的ip地址
     */
    public static String getIpString(long ipNumber) {
    ...
    public static int getIpInt(String ipAddress) {
    ...
    public static void main(String[] args) {
        Integer longIp = getIpInt("127.0.0.1");
        System.out.println(longIp);
        System.out.println(("" + longIp).length());
        System.out.println(("" + Integer.MAX_VALUE).length());

        System.out.println(         getIpInt("127.0.0.1"));//2130706433
        System.out.println(         getIpInt("0.0.0.0"));//0
    }
